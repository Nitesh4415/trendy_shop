...
### Android Setup
1. ***Install Android Studio:*** Ensure you have Android Studio version 2024.3 or later.

2. ***Android SDK:*** Use the SDK Manager in Android Studio to install Android SDK Platform 35.

3. ***Emulator/Device:*** Set up an Android Emulator (API 34+) or connect a physical Android device with USB debugging enabled.
...
2. ***Connect Flutter App:*** Follow the official guide to add Firebase to your Flutter app by running the flutterfire configure command from your project's root directory. This will automatically generate the firebase_options.dart file.
...
4. ***Enable Authentication Methods:*** In the Firebase Console, go to Authentication > Sign-in method and enable the Email/Password and Google providers.

## Stripe Payment Integration
The app uses Stripe for payment processing.

1. ***Create a Stripe Account:*** Sign up for a free account at stripe.com.

2. ***Get API Keys:*** In your Stripe Dashboard, go to Developers > API keys. You will need your Publishable key.
...
3. ***Run Build Runner:*** This generates the necessary files for dependency injection and data models.

         flutter pub run build_runner build --delete-conflicting-outputs

4. ***Run the App:*** Make sure you have an emulator running or a device connected.
